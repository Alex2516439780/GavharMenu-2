    ...
    updateDishesData(dishes);
        ...
        dishElement.innerHTML = `
            <div class="dish-item-header">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <div class="dish-item-info">
                        <div class="dish-item-name">${dish.name.ru}</div>
                        <div class="dish-item-category">${dish.categoryName?.ru || dish.category}</div>
                        <div class="dish-item-price">${dish.price.toLocaleString()} сум</div>
            ...
            <div class="dish-item-actions">
                ...
                <button class="action-btn status-btn ${dish.inStock ? '' : 'inactive'}"
                        data-action="toggle" data-id="${dish.id}">
